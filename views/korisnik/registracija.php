...
?>
<?php
// HR: Naslov stranice - registracija korisnika
// EN: Page title - user registration
?>
  <h2><?= _t('Registracija') ?></h2>
<?php
// HR: Forma za registraciju, koristi POST metodu i CSRF zaštitu
// EN: Registration form, uses POST method and CSRF protection
?>
  <form method="post" action="<?= App::urlFor('register.submit') ?>">
<?php
// HR: CSRF token za zaštitu forme
// EN: CSRF token for form protection
?>
    <?= Csrf::input() ?>
    <div class="row">
      <div class="col-md-4 mb-3">
<?php
// HR: Polje za unos imena
// EN: Input field for first name
?>
      ...
      <div class="col-md-4 mb-3">
<?php
// HR: Polje za unos prezimena
// EN: Input field for last name
?>
      ...
      <div class="col-md-4 mb-3">
<?php
// HR: Polje za unos OIB-a (11 znamenki)
// EN: Input field for OIB (11 digits)
?>
...
<?php
// HR: Polje za unos jedinstvenog korisničkog imena
// EN: Input field for unique username
?>
      ...
      <div class="col-md-6 mb-3">
<?php
// HR: Polje za unos jedinstvene e-mail adrese
// EN: Input field for unique email address
?>
    ...
    <div class="mb-3">
<?php
// HR: Polje za unos lozinke
// EN: Input field for password
?>
    ...
    <div class="mb-3">
<?php
// HR: Polje za unos potvrde lozinke
// EN: Input field for password confirmation
?>
...
<?php
// HR: Gumb za slanje forme i registraciju
// EN: Submit button for form registration
?>
