...
class HelperController
{
   ...
   */
  public function renderPagination(int $page, string|int $perPage, int $total, string $sort, string $dir, string $route): string
  {
    ...
    $html .= '<a class="page-link" href="'.$route.'?page='.max(1, $page - 1).'&per_page='.$perPage.'&sort='.$sort.'&dir='.$dir.'">&laquo;</a></li>';

    $renderPageItem = function($i) use ($page, $perPage, $sort, $dir, $route) {
      ...
      $url = $route.'?page='.$i.'&per_page='.$perPage.'&sort='.$sort.'&dir='.$dir;
    ...
    $html .= '<a class="page-link" href="'.$route.'?page='.min($totalPages, $page + 1).'&per_page='.$perPage.'&sort='.$sort.'&dir='.$dir.'">&raquo;</a></li>';
